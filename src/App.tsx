    ...
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-amber-500/30">
      <header className="sticky top-0 z-40 px-6 h-24 flex items-center justify-between bg-[#050505]/90 backdrop-blur-2xl border-b border-white/5">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => { resetForm(); setEditingClient(null); setIsModalOpen(true); }} className="bg-amber-500 text-black px-5 py-3 rounded-2xl font-black text-xs flex items-center gap-2 shadow-lg shadow-amber-500/10 active:scale-95 transition-all">
            <UserPlus size={18} /> <span className="hidden sm:inline uppercase">Novo Cliente</span>
          </button>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="relative inline-block">
            <select 
              ...
              className="appearance-none bg-zinc-900 border border-white/10 rounded-2xl px-6 py-4 pr-12 text-[10px] font-black uppercase tracking-widest outline-none focus:border-amber-500/50 cursor-pointer w-full sm:w-auto"
            >
